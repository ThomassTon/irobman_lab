...
goal1 (bin1){ joint:rigid type:ssBox, size:[0.15 0.15 0.1 .01], contact:0 Q:<[  0, 0.0, 0.13, 1., 0., .0, 0]> color:[0.4, 1, 1, 0.2]}
goal2 (bin2){ joint:rigid type:ssBox, size:[0.2 0.2 0.1 .01], contact:0 Q:<[  0, 0.05, 0.03, 1., 0., .0, 0]> color:[0.4, 1, 1, 0.2]}

obj2 (bin1){ joint:rigid type:ssBox, size:[0.2 0.2 0.1 .01], contact:1 Q:<[ 0, -0., 0.03, 1, 0, .0, 0]> color:[0.4, 1, 1, 1]}

obj1 (bin2){ joint:rigid type:ssBox, size:[0.15 0.15 0.1 .01], contact:1 Q:<[  -0., -0.15, 0.03, 1, 0, .0, 0]> color:[0.4, 1, 1, 1]}

...
obj1 (bin1){ joint:rigid type:ssBox, size:[0.2 0.2 0.1 .01], contact:1 Q:<[  -0.07, -0., 0.03, 1, 0, .0, 0]> color:[0.4, 1, 1, 1]}


goal1 (bin2){ joint:rigid type:ssBox, size:[0.2 0.2 0.1 .01], contact:0 Q:<[  -0.1, -0.1, 0.03, 1, 0, .0, 0]> color:[0.4, 1, 1, 0.2]}

...
obj1 (bin1){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:1 Q:<[  -0.07, -0., 0.03, 1, 0, .0, 0]> color:[0.4, 1, 1, 1]}
obj2 (bin1){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:1 Q:<[  0.1, 0., 0.03, 1, 0, .0, 0]> color:[1, 1, 0, 1]}
obj3 (bin1){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:1 Q:<[  -0.1, 0.15, 0.03, 1, 0, .0, 0]> color:[1, 1, 0.5, 1]}
obj4 (bin1){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:1 Q:<[  0.07, 0.065, 0.03, 1, 0, .0, 0]> color:[0.5, 0, 1, 1]}
obj5 (bin1){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:1 Q:<[  -0.1, -0.1, 0.03, 1, 0, .0, 0]> color:[1, 1, 1, 1]}

goal1 (bin2){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:0 Q:<[  -0.1, -0.1, 0.03, 1, 0, .0, 0]> color:[0.4, 1, 1, 0.2]}
goal2 (bin2){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:0 Q:<[  0.0, -0.15, 0.03, 1, 0, .0, 0]> color:[1, 1, 0, 0.2]}
goal3 (bin2){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:0 Q:<[  0.12, -0.12, 0.03, 1, 0, .0, 0]> color:[1, 1, 0.5, 0.2]}
goal4 (bin2){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:0 Q:<[  0.07, 0.1, 0.03, 1, 0, .0, 0]> color:[0.5, 0, 1, 0.2]}
goal5 (bin2){ joint:rigid type:ssBox, size:[0.06 0.06 0.06 .01], contact:0 Q:<[  -0.07, 0.0, 0.03, 1, 0, .0, 0]> color:[1, 1, 1, 0.2]}

...
#goal2 (bin1){ joint:rigid type:ssBox, size:[0.25 0.2 0.1 .01], contact:0 Q:<[  0, 0.3, 0.3, 0.714, 0.714, .0, 0]> color:[0.4, 1, 1, 0.2]}
goal1 (bin1){ joint:rigid type:ssBox, size:[0.17 0.17 0.1 .01], contact:0 Q:<[  0, 0., 0.03, 1., 0., .0, 0]> color:[0.4, 1, 1, 0.2]}


obj1 (bin2){ joint:rigid type:ssBox, size:[0.17 0.17 0.1 .01], contact:1 Q:<[ -0.07, -0., 0.03, 1, 0, .0, 0]> color:[0.4, 1, 1, 1]}

#obj2 (bin2){ joint:rigid type:ssBox, size:[0.25 0.2 0.1 .01], contact:1 Q:<[ -0.07, -0., 0.03, 1, 0, .0, 0]> color:[0.4, 1, 1, 1]}
